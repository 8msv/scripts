...
local Window = Library.CreateLib("Rate my Avatar GUI | cryniz, noxu | Remade by Vx#4796 |", "Ocean")
...
Section:NewButton("Abandon Booth", "abandons current owned booth", function()
    local args = {
    [1] = "Abandon",
}
game:GetService("ReplicatedStorage").CustomiseBooth:FireServer(unpack(args))
...
Section:NewToggle("YIPEE", "cryniz#5446 , noxu#0001", function(state)
    if state then
        yipeeCond = true
...
Section:NewToggle("WYSI", "cryniz#5446 , noxu#0001", function(state)
    if state then
    wysiCond = true
...
Section:NewToggle("Happy Cat", "cryniz#5446 , noxu#0001", function(state)
    if state then
    happyCatCond = true
	wait(0.1)
...
Section:NewToggle("Pug", "cryniz#5446 , noxu#0001", function(state)
    if state then
	pugCond = true
	wait(0.2)
...
Section:NewButton("Teleport to an unclaimed booth", "Random", function()
...
Section:NewLabel("Booth Misc")
Section:NewButton("Public Chat", "Game's Chat", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/rouxhaver/scripts/71e437682e20bb6744e9b777640943fc4a5ec5b1/rate_my_avatar_public_chat.lua'))()
end)
Section:NewButton("MS Paint", "Interactive Booth Paint", function()
...
Section:NewButton("Rock Paper Scissors", "start by saying any option", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/8msv/scripts/c0f6efd87ead975f669029f2947ce5fa8abd4b27/rps'))()
end)
Section:NewButton("Snake", "snake on booth", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/8msv/scripts/main/snake'))()
end)
...
Section:NewButton("HomeBrew Admin", "penis", function()
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Syntaxx64/HomebrewAdmin/master/Main"))()
end)
Section:NewButton("C00lGUI", "penis", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/8msv/scripts/3c5b5eb172394e8e68c24bce794558506adf5ba7/c00lgui_v3.5.txt'))()
end)
...
Section:NewKeybind("Open/Close GUI", "Hide and reappear", Enum.KeyCode.Z, function()
	Library:ToggleUI()
end)
